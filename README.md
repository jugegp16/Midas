...
- **Live** poll real-time prices and get trade alerts -- in the terminal, and optionally pushed to Discord where a ✅ reaction confirms the fill ([setup](docs/cli.md#discord-push-notifications--fill-confirmation))
